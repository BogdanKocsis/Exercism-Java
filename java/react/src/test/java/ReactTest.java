...
public class ReactTest {
    ...
    public void testComputeCellCalculateInitialValue() {
        ...
        var output = React.computeCell(list -> list.getFirst() + 1, List.of(input));
    ...
    public void testComputeCellsInTheRightOrder() {
        ...
        var output = React.computeCell(list -> list.getFirst() + list.get(1) * 10, List.of(first, second));
    ...
    public void testComputeCellsCanDependOnOtherComputeCells() {
        var input = React.inputCell(1);
        var timesTwo = React.computeCell(list -> list.getFirst() * 2, List.of(input));
        var timesThirty = React.computeCell(list -> list.getFirst() * 30, List.of(input));
        var output = React.computeCell(list -> list.getFirst() + list.get(1), List.of(timesTwo, timesThirty));
    ...
    public void testCallbacksOnlyFireOnChange() {
        var input = React.inputCell(1);
        var output = React.computeCell(list -> list.getFirst() < 3 ? 111 : 222, List.of(input));
    ...
    public void testCallbacksCanFireFromMultipleCells() {
        var input = React.inputCell(1);
        var plusOne = React.computeCell(list -> list.getFirst() + 1, List.of(input));
        var minusOne = React.computeCell(list -> list.getFirst() - 1, List.of(input));
    ...
    public void testCallbacksShouldOnlyBeCalledOnceEvenIfMultipleDependenciesChange() {
        var input = React.inputCell(1);
        var plusOne = React.computeCell(list -> list.getFirst() + 1, List.of(input));
        var minusOne1 = React.computeCell(list -> list.getFirst() - 1, List.of(input));
        var minusOne2 = React.computeCell(list -> list.getFirst() - 1, List.of(minusOne1));
        var output = React.computeCell(list -> list.getFirst() * list.get(1), List.of(plusOne, minusOne2));
    ...
    public void testCallbacksShouldNotBeCalledIfDependenciesChangeButOutputValueDoesntChange() {
        ...
        var plusOne = React.computeCell(list -> list.getFirst() + 1, List.of(input));
        var minusOne = React.computeCell(list -> list.getFirst() - 1, List.of(input));
        var alwaysTwo = React.computeCell(list -> list.getFirst() - list.get(1), List.of(plusOne, minusOne));
