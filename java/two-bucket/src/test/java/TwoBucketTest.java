...
public class TwoBucketTest {
    ...
    public void testBucketOneSizeThreeBucketTwoSizeFiveStartWithOne() {
        ...
        assertThat(bucketResult.totalMoves()).isEqualTo(4);
        assertThat(bucketResult.finalBucket()).isEqualTo("one");
        assertThat(bucketResult.otherBucket()).isEqualTo(5);
    ...
    public void testBucketOneSizeThreeBucketTwoSizeFiveStartWithTwo() {
        ...
        assertThat(bucketResult.totalMoves()).isEqualTo(8);
        assertThat(bucketResult.finalBucket()).isEqualTo("two");
        assertThat(bucketResult.otherBucket()).isEqualTo(3);
    ...
    public void testBucketOneSizeSevenBucketTwoSizeElevenStartWithOne() {
        ...
        assertThat(bucketResult.totalMoves()).isEqualTo(14);
        assertThat(bucketResult.finalBucket()).isEqualTo("one");
        assertThat(bucketResult.otherBucket()).isEqualTo(11);
    ...
    public void testBucketOneSizeSevenBucketTwoSizeElevenStartWithTwo() {
        ...
        assertThat(bucketResult.totalMoves()).isEqualTo(18);
        assertThat(bucketResult.finalBucket()).isEqualTo("two");
        assertThat(bucketResult.otherBucket()).isEqualTo(7);
    ...
    public void testBucketOneSizeOneBucketTwoSizeThreeStartWithTwo() {
        ...
        assertThat(bucketResult.totalMoves()).isEqualTo(1);
        assertThat(bucketResult.finalBucket()).isEqualTo("two");
        assertThat(bucketResult.otherBucket()).isEqualTo(0);
    ...
    public void testBucketOneSizeTwoBucketTwoSizeThreeStartWithOne() {
        ...
        assertThat(bucketResult.totalMoves()).isEqualTo(2);
        assertThat(bucketResult.finalBucket()).isEqualTo("two");
        assertThat(bucketResult.otherBucket()).isEqualTo(2);
    ...
    public void testBucketOneMuchBiggerThanBucketTwo() {
        ...
        assertThat(bucketResult.totalMoves()).isEqualTo(6);
        assertThat(bucketResult.finalBucket()).isEqualTo("one");
        assertThat(bucketResult.otherBucket()).isEqualTo(1);
    ...
    public void testBucketOneSizeSixBucketTwoSizeFifteenStartWithOne() {
        ...
        assertThat(bucketResult.totalMoves()).isEqualTo(10);
        assertThat(bucketResult.finalBucket()).isEqualTo("two");
        assertThat(bucketResult.otherBucket()).isEqualTo(0);
